...
import com.example.appdbservice.payload.ErrorData;
...
public class RestException extends RuntimeException{
    ...
    public static RestException unauthorization(String userMsg) {
        return new RestException(userMsg, HttpStatus.UNAUTHORIZED);
    }
